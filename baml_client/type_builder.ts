...
export default class TypeBuilder {
	...
	WhatsAppScreenshot: ClassViewer<
		"WhatsAppScreenshot",
		| "chat_name"
		| "chat_type"
		| "messages"
		| "visible_date_separators"
		| "screenshot_context"
		| "participant_count"
	>;

	MediaType: EnumViewer<
		"MediaType",
		| "Text"
		| "Image"
		| "Video"
	...
	constructor() {
		this.tb = new _TypeBuilder({
			classes: new Set(["Resume", "WhatsAppMessage", "WhatsAppScreenshot"]),
			enums: new Set(["MediaType", "MessageStatus"]),
